 ...
 *
 * OWASP ASVS Level 3 Compliant Input Validation:
 * - VUL-003: Path traversal prevention
 * - VUL-007: Input validation (alphanumeric only)
 * - VUL-016: Environment configuration
 * - VUL-021: API consistency
 */
